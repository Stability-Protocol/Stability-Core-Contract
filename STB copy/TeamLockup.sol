...
contract TeamLockup {
    ...
    constructor(address _multisig, IERC20 _STB, uint _start, uint _length, uint _total) public {
        multisig = _multisig;
        STB = _STB;
    ...
    function claimYeti(uint _amount) external onlyMultisig {
        ...
        require(totalClaimed < totalVest, "All STB has been vested");
        ...
        if (available >= totalClaimed.add(_amount)) {
            ...
            require(STB.transfer(multisig, _amount));
        }
    }
