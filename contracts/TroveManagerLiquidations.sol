...
contract TroveManagerLiquidations is TroveManagerBase, ITroveManagerLiquidations {
    ...
    struct LiquidationTotals {
        ...
        uint256 totalSUSDGasCompensation;
    ...
    struct LocalVariables_LiquidationSequence {
        uint256 remainingSUSDInStabPool;
        uint256 i;
        uint256 ICR;
        address user;
    ...
    function setAddresses(
        ...
        address _stabilityFinanceTreasury
    ) external onlyOwner {
        ...
        stabilityFinanceTreasury = _stabilityFinanceTreasury;
    ...
    function batchLiquidateTroves(address[] memory _troveArray, address _liquidator) external override {
        ...
        vars.SUSDInStabPool = stabilityPoolCached.getTotalSUSDDeposits();
        ...
        emit Liquidation(
            vars.liquidatedDebt,
            totals.totalSUSDGasCompensation,
    ...
    function _getTotalFromBatchLiquidate_RecoveryMode(
        ...
        uint256 _SUSDInStabPool,
        address[] memory _troveArray
    ) internal returns (LiquidationTotals memory totals) {
        LocalVariables_LiquidationSequence memory vars;
        LiquidationValues memory singleLiquidation;

        vars.remainingSUSDInStabPool = _SUSDInStabPool;
        ...
        for (vars.i = 0; vars.i < troveArrayLen; ++vars.i) {
            ...
            if (!vars.backToNormalMode) {
                ...
                if (vars.ICR >= MCR && vars.remainingSUSDInStabPool == 0) {
                    continue;
                }
                ...
                singleLiquidation = _liquidateRecoveryMode(
                    ...
                    vars.user,
                    vars.ICR,
                    vars.remainingSUSDInStabPool,
                    TCR
                );

                // Update aggregate trackers
                vars.remainingSUSDInStabPool = vars.remainingSUSDInStabPool.sub(
    ...
    function _liquidateNormalMode(
        ...
        singleLiquidation.SUSDGasCompensation = SUSD_GAS_COMPENSATION;
        ...
        _updateWAssetsRewardOwner(collsToUpdate, _borrower, stabilityFinanceTreasury);
    ...
    function _liquidateRecoveryMode(
        ...
        if (_ICR <= _100pct) {
            ...
            _updateWAssetsRewardOwner(singleLiquidation.collToRedistribute, _borrower, stabilityFinanceTreasury);
           ...
           (_ICR < _TCR) && (singleLiquidation.entireTroveDebt <= _SUSDInStabPool)
        ) {
            troveManager.movePendingTroveRewardsToActivePool(
                _activePool,
                _defaultPool,
            ...
            require(_SUSDInStabPool != 0, "TML: zero SUSD in Stab Pool");
    ...
    function _getOffsetAndRedistributionVals(
        ...
        if (_SUSDInStabPool != 0) {
            ...
            or_vals.debtToOffset = LiquityMath._min(_entireTroveDebt, _SUSDInStabPool);
    ...
    function _addLiquidationValuesToTotals(
        ...
        newTotals.totalSUSDGasCompensation = oldTotals.totalSUSDGasCompensation.add(
            singleLiquidation.SUSDGasCompensation
        );
    ...
    */
    ...
    function _sendGasCompensation(
        ...
        if (_SUSD != 0) {
            susdTokenContract.returnFromPool(gasPoolAddress, _liquidator, _SUSD);
        }
