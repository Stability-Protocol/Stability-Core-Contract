...
* common functions. 
*/
contract LiquityBase is ILiquityBase, StabCustomBase {
    ...
    uint constant public SUSD_GAS_COMPENSATION = 50e18;

    // Minimum amount of net SUSD debt a must have
    ...
    function getEntireSystemDebt() public override view returns (uint) {
        uint activeDebt = activePool.getSUSDDebt();
        uint closedDebt = defaultPool.getSUSDDebt();
