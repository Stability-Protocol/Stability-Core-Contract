...
interface IStabilityPool is ICollateralReceiver {
    ...
    event StabilityPoolSUSDBalanceUpdated(uint _newBalance);
    ...
    event ETHGainWithdrawn(address indexed _depositor, uint _ETH, uint _SUSDLoss);
    event STBPaidToDepositor(address indexed _depositor, uint _STB);
    event STBaidToFrontEnd(address indexed _frontEnd, uint _STB);
...
//     */
     ...
     */
    function getTotalSUSDDeposits() external view returns (uint);
     ...
     */
    function getDepositorSTBGain(address _depositor) external view returns (uint);

    /*
     * Return the YETI gain earned by the front end.
     */
    function getFrontEndSTBGain(address _frontEnd) external view returns (uint);

    /*
     * Return the user's compounded deposit.
     */
    function getCompoundedSUSDDeposit(address _depositor) external view returns (uint);
